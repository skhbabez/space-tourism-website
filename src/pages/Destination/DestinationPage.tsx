...
const DestinationPage = ({
  ...
  return (
    <section
      className={clsx(
        "flex flex-col gap-8 xl:flex-row xl:justify-between xl:max-h-183.5 xl:h-full",
        className,
      )}
      {...props}
    >
      ...
      <div className="contents md:flex md:justify-center md:items-center md:py-[11.5px] xl:flex-1">
        <div className="flex flex-col self-center gap-6 xl:gap-10 max-w-81.75 md:max-w-lg xl:max-w-111.25">
          <ul
            role="tablist"
